...
public class ForggetPassword extends AppCompatActivity {
            ...
            if (http.Result != null) {
                if (http.Result.toString().trim().length()>2) { // + http.Result
                    ...
                    if (youxiang.getText().toString().trim()!=null&&youxiang.getText().toString().trim().length()>4) {
                        ...
                        String content="您的帐号找回密码为： " + http.Result.toString().trim() + " 。CA，竭诚为您服务！ 如您没有进行此操作，无需理会此邮件!";

                        try {
                            sendEmail(youxiang.getText().toString().trim(),"“CA”密码找回邮件!", content);
                            flagz=1;
                        } catch (Exception e) {
                            flagz=0;
                            e.printStackTrace();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        huoquyan=(Button)findViewById(R.id.button12);
        chakanyan=(Button)findViewById(R.id.button13);
        tijiao=(Button)findViewById(R.id.button14);
        shuoming=(TextView) findViewById(R.id.textView9);
        youxiang=(EditText)findViewById(R.id.editText3);
        yanzheng=(EditText)findViewById(R.id.editText4);
        tijiaojiazai=(ProgressBar)this.findViewById(R.id.progressBar3);
        ...
        huoquyan.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                if (youxiang.getText().toString().trim()!=null&&youxiang.getText().toString().trim().length()>4) {
                    ...
                    try {
                        sendEmail(youxiang.getText().toString().trim(),"“CA”帐号验证邮件!", content);
                        flag=1;
                    } catch (Exception e) {
                        flag=0;
                        e.printStackTrace();
    ...
    public Boolean panduan(){
        if (youxiang.getText().toString().trim()==null||youxiang.getText().toString().trim()==""||youxiang.getText().toString().trim().length()<2){
            ...
            Toast.makeText(ForggetPassword.this,"邮箱不能为空！",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ForggetPassword.this,"验证码不正确！",Toast.LENGTH_SHORT).show();
            yanzheng.setText("");
