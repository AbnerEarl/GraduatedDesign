...
public class AddApp extends AppCompatActivity {
    ...
    private Button selectall,cancelall,selectpart,addapp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.lvaddapp);
        selectall=(Button)this.findViewById(R.id.button29);
        cancelall=(Button)this.findViewById(R.id.button31);
        selectpart=(Button)this.findViewById(R.id.button30);
        addapp=(Button)this.findViewById(R.id.btnadd);
        ...
        mAdapter = new AddApp.MyAdapter(this);//得到一个MyAdapter对象
        ...
        addapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*new  AlertDialog.Builder(AddApp.this)
                        .setTitle("系统提示")
                        .setMessage("应用添加成功，可选择“进入应用”进行使用！"+myappid)
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder = (AddApp.ViewHolder)convertView.getTag();//取出ViewHolder对象
            }
            ...
            holder.trylook.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(AddApp.this,ApplicationLoad.class);
        ...
        public void Func() {
            if (http.Result != null) {
                if (http.Result.equals("true")) {
                    Toast.makeText(AddApp.this, "添加应用成功！" + http.Result, Toast.LENGTH_SHORT).show();
                    AddApp.this.finish();
                    //denglu.setText("服务器回复的信息 : " + http.Result);
                } else {
                    Toast.makeText(AddApp.this, "添加应用失败！请检查网络连接是否正确，稍后重试！"+http.Result, Toast.LENGTH_SHORT).show();
                }
            }
        }
    });
        ...
        public void Func() {
            if (http1.Result != null) {
                ...
                for (int i=0;i<userappid.length-1;i++){
                    for (int j=0;j<appid.length;j++){
                        if (userappid[i].trim().equals(appid[j])){
                            appid[j]=0;
                        }
                    }
                }
                ...
                Toast.makeText(AddApp.this, "获取用户信息失败，无法完成添加应用！请检查网络连接是否正确，退出后重试！"+http1.Result, Toast.LENGTH_SHORT).show();
